Contributing to HanaCryptoBank Core
============================

The HanaCryptoBank Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/hanacryptobank-project/hanacryptobank/blob/master/doc/translation_process.md)
...
The following applies to code changes to the HanaCryptoBank Core project, and is not to be
confused with overall HanaCryptoBank Network Protocol consensus changes.

Whether a pull request is merged into HanaCryptoBank Core rests with the project merge
...
Patches that change HanaCryptoBank consensus rules are considerably more involved than
...
Where a patchset proposes to change the HanaCryptoBank consensus, it must have been
...
The project leader is the release manager for each HanaCryptoBank Core release.
