...
pkgdatadir = $(datadir)/hanacryptobank
pkgincludedir = $(includedir)/hanacryptobank
pkglibdir = $(libdir)/hanacryptobank
pkglibexecdir = $(libexecdir)/hanacryptobank
...
BITCOIN_DAEMON_NAME = hanacryptobankd
...
ZMQ_LIBS = -lzmq
abs_builddir = /home/server18/hcb
abs_srcdir = /home/server18/hcb
abs_top_builddir = /home/server18/hcb
abs_top_srcdir = /home/server18/hcb
ac_ct_AR = 
ac_ct_CC = 
ac_ct_CXX = 
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/server18/hcb/build-aux/install-sh
...
src/config/hanacryptobank-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/hanacryptobank-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/hanacryptobank-config.h
$(top_srcdir)/src/config/hanacryptobank-config.h.in:  $(am__configure_deps) 
