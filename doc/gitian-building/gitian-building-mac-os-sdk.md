...
The script [extract-osx-sdk.sh](https://github.com/hanacryptobank-project/hanacryptobank/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
hanacryptobank/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/hanacryptobank-project/hanacryptobank/blob/master/doc/README_osx.md) for troubleshooting tips.