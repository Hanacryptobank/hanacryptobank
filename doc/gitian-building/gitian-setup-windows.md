...
The build script we'll be using is contained in the HanaCryptoBank github repository ([contrib/gitian-build.py](https://github.com/hanacryptobank-project/hanacryptobank/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the HanaCryptoBank repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/HanaCryptoBank-Project/HanaCryptoBank/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, hanacryptobank-detached-sigs, and hanacryptobank GitHub repos.
