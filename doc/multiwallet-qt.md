...
In order to support loading of multiple wallets in hanacryptobank-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hanacryptobank.cpp.
...
Changes to hanacryptobank.cpp
----------------------
hanacryptobank.cpp is the entry point into hanacryptobank-qt, and as such, will require some minor modifications to provide hooks for
