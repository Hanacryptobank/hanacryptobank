...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/hanacryptobank-project/hanacryptobank/gitian.sigs.git
...
### Build and sign HanaCryptoBank Core for Linux, Windows, and OS X:

    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit hanacryptobank=v${VERSION} ../hanacryptobank/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit hanacryptobank=v${VERSION} ../hanacryptobank/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit hanacryptobank=v${VERSION} ../hanacryptobank/contrib/gitian-descriptors/gitian-osx.yml
    ...
    ./bin/gbuild --memory 3000 --commit hanacryptobank=v${VERSION} ../hanacryptobank/contrib/gitian-descriptors/gitian-aarch64.yml
    ./bin/gsign --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs/ ../hanacryptobank/contrib/gitian-descriptors/gitian-aarch64.yml
    mv build/out/hanacryptobank-*.tar.gz build/out/src/hanacryptobank-*.tar.gz ../
    popd
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`hanacryptobank-${VERSION}-osx-unsigned.dmg`, `hanacryptobank-${VERSION}-osx64.tar.gz`)
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import hanacryptobank/contrib/gitian-keys/*.gpg
    gpg --refresh-keys
...
Codesigner only: Sign the osx binary:
    ...
    transfer hanacryptobank-osx-unsigned.tar.gz to osx for signing
...
space *do not upload these to the hanacryptobankcoin.com server*.
