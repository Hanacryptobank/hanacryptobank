...
This document provides guidelines for internationalization of the HanaCryptoBank Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to HanaCryptoBank network</numerusform>
            <numerusform>%n active connections to HanaCryptoBank network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hanacryptobank_en.ts` remains unchanged.
