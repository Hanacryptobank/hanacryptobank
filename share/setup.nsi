...
!define MUI_HEADERIMAGE_BITMAP "/home/server18/hcb/share/pixmaps/nsis-header.bmp"
!define MUI_FINISHPAGE_NOAUTOCLOSE
!define MUI_STARTMENUPAGE_REGISTRY_ROOT HKLM
!define MUI_STARTMENUPAGE_REGISTRY_KEY ${REGKEY}
!define MUI_STARTMENUPAGE_REGISTRY_VALUENAME StartMenuGroup
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "HanaCryptoBank Core"
!define MUI_FINISHPAGE_RUN $INSTDIR\hanacryptobank-qt.exe
!define MUI_UNICON "${NSISDIR}\Contrib\Graphics\Icons\modern-uninstall.ico"
!define MUI_UNWELCOMEFINISHPAGE_BITMAP "/home/server18/hcb/share/pixmaps/nsis-wizard.bmp"
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File /home/server18/hcb/release/hanacryptobank-qt.exe
    File /oname=COPYING.txt /home/server18/hcb/COPYING
    File /oname=readme.txt /home/server18/hcb/doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File /home/server18/hcb/release/hanacryptobankd.exe
    File /home/server18/hcb/release/hanacryptobank-cli.exe
    SetOutPath $INSTDIR\doc
    File /r /home/server18/hcb/doc\*.*
    SetOutPath $INSTDIR
...
Section -post SEC0001
    ...
    WriteRegStr HKCR "hanacryptobank" "URL Protocol" ""
    WriteRegStr HKCR "hanacryptobank" "" "URL:HanaCryptoBank"
    WriteRegStr HKCR "hanacryptobank\DefaultIcon" "" $INSTDIR\hanacryptobank-qt.exe
    WriteRegStr HKCR "hanacryptobank\shell\open\command" "" '"$INSTDIR\hanacryptobank-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\hanacryptobank-qt.exe
...
Section -un.post UNSEC0001
    ...
    DeleteRegKey HKCR "hanacryptobank"
