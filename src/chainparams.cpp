...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("047932dc6a4987e172c126a858bc7fd2319c95fbc4f498f2d18724a064d6c5955f20d359a02c3168079fc8249d541beb39537fe32880d9cf0bc2d8ad65a04ae01d");
        nDefaultPort = 7070;
       bnProofOfWorkLimit = ~uint256(0) >> 20;
        ...
        const char* pszTimestamp = "HANACRYPTOBANK - new era of crypto banks";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040b0dd7ee8a1a95a0761141cb66bb2efdb1d7227217f5e6a2bfd41d89efccd1ddb31cf851a18a47a1c6e4e070ee37435a3a7b8125b381bf7f779c0174e40a38ff") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1591246618;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 190860;
        ...
        assert(hashGenesisBlock == uint256("0x00000f583aee97686bb85499d6aabd5fa19e69f376450f0eaf29b82cafba70bf"));
        assert(genesis.hashMerkleRoot == uint256("0x39512f2758d56574958438d93e9ee27c002c8b68b956e667048911450922378c"));
		
        vSeeds.push_back(CDNSSeedData("88.198.133.121", "88.198.133.121"));
        vSeeds.push_back(CDNSSeedData("88.198.133.122", "88.198.133.122"));
		vSeeds.push_back(CDNSSeedData("185.88.177.52", "185.88.177.52"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // HanaCryptoBank: 1 day
        nTargetSpacing = 1 * 60;  // HanaCryptoBank: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testnet.hcb.io", "testnet.hcb.io"));         // Single node address
        vSeeds.push_back(CDNSSeedData("testnet1.hcb.io", "testnet1.hcb.io"));       // Single node address
        vSeeds.push_back(CDNSSeedData("testnet.hanacryptobankcoin.org", "testnet.hanacryptobankcoin.org"));       // Single node address


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet hanacryptobank addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet hanacryptobank script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet hanacryptobank BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet hanacryptobank BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet hanacryptobank BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // HanaCryptoBank: 1 day
        nTargetSpacing = 1 * 60;        // HanaCryptoBank: 1 minutes
