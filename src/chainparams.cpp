...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000006cae0d35b6935f48801b203e2d357c7a93ebe8f39d99ea84e60a97ee60f"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 17070;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // HanaCryptoBank starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 500;
        nHanaCryptoBankBadBlockTime = 4070908800; // Skip nBit validation of Block 259201 per PR #915
        nHanaCryptoBankBadBlocknBits = 0x00; // Skip nBit validation of Block 259201 per PR #915
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "HANACRYPTOBANK - new era of crypto banks is here";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1593775933;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2820297;
        ...
        assert(hashGenesisBlock == uint256("00000ca68d76088bde79871b31fe96893ad36ba33db5dc010bb2c18239a76ce1"));
        assert(genesis.hashMerkleRoot == uint256("35ce68fe56575749d7eff5eff84e69c47dd8bbcf661f40608da87a1c4b257a4f"));
		...
		vSeeds.push_back(CDNSSeedData("185.88.177.48", "185.88.177.48"));
        vSeeds.push_back(CDNSSeedData("37.221.113.80", "37.221.113.80"));
		vSeeds.push_back(CDNSSeedData("217.182.230.21", "217.182.230.21"));
		vSeeds.push_back(CDNSSeedData("185.88.177.78", "185.88.177.78"));
        vSeeds.push_back(CDNSSeedData("46.4.158.110", "46.4.158.110"));
		vSeeds.push_back(CDNSSeedData("107.173.209.241", "107.173.209.241"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nHanaCryptoBankBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nHanaCryptoBankBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "hanacryptobank-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "hanacryptobank-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("warrows.dev", "testnet.dnsseed.hanacryptobank.warrows.dev"));
        ...
        strSporkPubKey = "0485126a36740117077d8c3b7a503a79b6d696d0626c1d929b4242344fe3bf7dde8377dc19679466e28fffd1aad4e6b2b3ee74de1d96de5fdb5a4bdd5ba3dd6ebe";
        ...
        strObfuscationPoolDummyAddress = "51HVEfTw3TiSeQzQozSNWTyM3ADqr3J3oL";
