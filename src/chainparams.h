 ...
 * HanaCryptoBank system. There are three: the main network on which people trade goods
...
public:
    ...
    int HanaCryptoBankBadBlockTime() const { return nHanaCryptoBankBadBlockTime; }
    int HanaCryptoBankBadBlocknBits() const { return nHanaCryptoBankBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nHanaCryptoBankBadBlockTime;
    unsigned int nHanaCryptoBankBadBlocknBits;
