...
/** 
    ...
    ****Note - for HanaCryptoBank we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of hanacryptobank coming in to a transaction
