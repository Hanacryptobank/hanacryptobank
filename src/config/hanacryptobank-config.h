/* src/config/hanacryptobank-config.h.  Generated from hanacryptobank-config.h.in by configure.  */
/* src/config/hanacryptobank-config.h.in.  Generated from configure.ac by autoheader.  */
