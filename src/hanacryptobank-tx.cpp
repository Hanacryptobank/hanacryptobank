...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("HanaCryptoBank Core hanacryptobank-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hanacryptobank-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hanacryptobank transaction") + "\n" +
                               "  hanacryptobank-tx [options] -create [commands]   " + _("Create hex-encoded hanacryptobank transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hanacryptobank transaction
