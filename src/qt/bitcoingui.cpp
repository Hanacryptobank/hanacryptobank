                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("HanaCryptoBank [HCB]") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a HanaCryptoBank address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hanacryptobank: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zHCB"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About HanaCryptoBank Core"), this);
    aboutAction->setStatusTip(tr("Show information about HanaCryptoBank Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HanaCryptoBank"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your HanaCryptoBank addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HanaCryptoBank addresses"));
    ...
    openAction->setStatusTip(tr("Open a HanaCryptoBank: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the HanaCryptoBank Core help message to get a list with possible HanaCryptoBank command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HanaCryptoBank network", "", count));
}
...
{
    QString strTitle = tr("HanaCryptoBank [HCB]"); // default title
