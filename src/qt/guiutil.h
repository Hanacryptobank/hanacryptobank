...
/** Utility functions used by the HanaCryptoBank Qt UI.
 */
namespace GUIUtil
{
...
// Render HanaCryptoBank addresses in monospace font
...
// Parse "hanacryptobank:" URI into recipient object, return true on successful parsing
