...
#include "qt/hanacryptobank/forms/ui_addresseswidget.h"
#include "qt/hanacryptobank/addresslabelrow.h"
#include "qt/hanacryptobank/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(HanaCryptoBankGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter HanaCryptoBank address"));
