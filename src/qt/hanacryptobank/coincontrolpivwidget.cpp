...
#include "qt/hanacryptobank/coincontrolpivwidget.h"
#include "qt/hanacryptobank/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select HCB Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("HCB");
    ...
    ui->labelValueAfter->setText("0.00 HCB");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 HCB");
    ui->labelValueFee->setText("0.00 HCB");
