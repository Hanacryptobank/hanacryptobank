...
#include "qt/hanacryptobank/forms/ui_coldstakingwidget.h"
#include "qt/hanacryptobank/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/hanacryptobank/requestdialog.h"
#include "qt/hanacryptobank/tooltipmenu.h"
#include "qt/hanacryptobank/furlistrow.h"
...
#include "qt/hanacryptobank/csrow.h"
...
ColdStakingWidget::ColdStakingWidget(HanaCryptoBankGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your HCBs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept HCB delegation / Delegate HCB"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select HCB outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 HCB" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
