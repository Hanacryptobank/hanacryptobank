...
#include "qt/hanacryptobank/furabstractlistitemdelegate.h"
#include "qt/hanacryptobank/txviewholder.h"
#include "qt/hanacryptobank/tooltipmenu.h"
#include "qt/hanacryptobank/sendmultirow.h"
#include "qt/hanacryptobank/coldstakingmodel.h"
#include "qt/hanacryptobank/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(HanaCryptoBankGUI* parent);
    ~ColdStakingWidget();
