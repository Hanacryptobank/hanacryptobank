...
#ifndef FURSZY_HanaCryptoBank_GUITRANSACTIONSUTILS_H
#define FURSZY_HanaCryptoBank_GUITRANSACTIONSUTILS_H
...
#endif //FURSZY_HanaCryptoBank_GUITRANSACTIONSUTILS_H
