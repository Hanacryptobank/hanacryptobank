...
#include "qt/hanacryptobank/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(HanaCryptoBankGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-hanacryptobank");
