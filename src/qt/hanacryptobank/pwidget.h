...
#include <QWidget>
#include <QString>
#include "qt/hanacryptobank/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(HanaCryptoBankGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    HanaCryptoBankGUI* getWindow() { return this->window; }
...
protected:
    HanaCryptoBankGUI* window = nullptr;
