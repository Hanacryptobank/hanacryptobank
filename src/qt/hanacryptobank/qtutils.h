...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, HanaCryptoBankGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, HanaCryptoBankGUI *gui, double posX = 3);
