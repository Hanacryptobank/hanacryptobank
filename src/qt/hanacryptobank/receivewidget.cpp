...
#include "qt/hanacryptobank/forms/ui_receivewidget.h"
...
#include "qt/hanacryptobank/addressholder.h"
...
ReceiveWidget::ReceiveWidget(HanaCryptoBankGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive HCB."));
