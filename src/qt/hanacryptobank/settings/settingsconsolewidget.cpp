...
#include "qt/hanacryptobank/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/hanacryptobank/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(HanaCryptoBankGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the HanaCryptoBank RPC console.") + "<br>" +
