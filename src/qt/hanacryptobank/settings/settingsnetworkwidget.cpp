...
#include "qt/hanacryptobank/settings/settingsnetworkwidget.h"
#include "qt/hanacryptobank/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/hanacryptobank/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(HanaCryptoBankGUI* _window, QWidget *parent) :
