...
#include "qt/hanacryptobank/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(HanaCryptoBankGUI* _window, QWidget *parent) :
