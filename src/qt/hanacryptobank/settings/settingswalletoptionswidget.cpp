...
#include "qt/hanacryptobank/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/hanacryptobank/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(HanaCryptoBankGUI* _window, QWidget *parent) :
