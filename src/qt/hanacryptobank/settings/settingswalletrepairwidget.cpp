...
#include "qt/hanacryptobank/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/hanacryptobank/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(HanaCryptoBankGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to HanaCryptoBankGUI::handleRestart()
