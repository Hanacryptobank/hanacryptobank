...
#include "qt/hanacryptobank/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/hanacryptobank/lockunlock.h"
#include "qt/hanacryptobank/qtutils.h"
#include "qt/hanacryptobank/receivedialog.h"
...
TopBar::TopBar(HanaCryptoBankGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("HanaCryptoBank")
    updateDisplayUnit();
