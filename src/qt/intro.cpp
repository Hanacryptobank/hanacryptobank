...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("HanaCryptoBank Core"),
     ...
     * override -datadir in the hanacryptobank.conf file in the default data directory
     * (to be consistent with hanacryptobankd behavior)
     */
