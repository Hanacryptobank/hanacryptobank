...
/** Interface from Qt to configuration data structure for HanaCryptoBank client.
...
public:
    ...
    enum OptionID {
        ...
        HideOrphans,    // bool
        AnonymizeHanaCryptoBankAmount, //int
...
signals:
    ...
    void anonymizeHanaCryptoBankAmountChanged(int);
