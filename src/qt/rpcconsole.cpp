                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzHCBPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzHCBPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzHCBPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzHCBPathCustom.empty()) && nCustomBackupThreshold > 0) {
