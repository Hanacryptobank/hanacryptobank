...
#ifndef HanaCryptoBank_QT_WALLETMODEL_H
#define HanaCryptoBank_QT_WALLETMODEL_H
...
/** Interface to HanaCryptoBank wallet from Qt view code. */
...
#endif // HanaCryptoBank_QT_WALLETMODEL_H
