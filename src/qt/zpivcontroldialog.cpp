// Copyright (c) 2017-2020 The HanaCryptoBank developers
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zHCB Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zHCB.";
            else if (!mint.isSeedCorrect)
                strReason = "The zHCB seed used to mint this zHCB is not the same as currently hold in the wallet";
            else
