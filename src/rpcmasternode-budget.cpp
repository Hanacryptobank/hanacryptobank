...
Value mnbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a HanaCryptoBank initiative\n"
            "  vote-alias         - Vote on a HanaCryptoBank initiative\n"
            "  vote               - Vote on a HanaCryptoBank initiative/budget\n"
...
Value submitbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"hanacryptobank-address\" monthy-payment \"fee-tx\"\n"
