...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop HanaCryptoBank server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "HanaCryptoBank server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HanaCryptoBank features */
        {"hanacryptobank", "masternode", &masternode, true, true, false},
        {"hanacryptobank", "listmasternodes", &listmasternodes, true, true, false},
        {"hanacryptobank", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hanacryptobank", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hanacryptobank", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hanacryptobank", "masternodedebug", &masternodedebug, true, true, false},
        {"hanacryptobank", "startmasternode", &startmasternode, true, true, false},
        {"hanacryptobank", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hanacryptobank", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hanacryptobank", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hanacryptobank", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hanacryptobank", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hanacryptobank", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hanacryptobank", "mnbudget", &mnbudget, true, true, false},
        {"hanacryptobank", "preparebudget", &preparebudget, true, true, false},
        {"hanacryptobank", "submitbudget", &submitbudget, true, true, false},
        {"hanacryptobank", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hanacryptobank", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hanacryptobank", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hanacryptobank", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hanacryptobank", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hanacryptobank", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hanacryptobank", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hanacryptobank", "checkbudgets", &checkbudgets, true, true, false},
        {"hanacryptobank", "mnsync", &mnsync, true, true, false},
        {"hanacryptobank", "spork", &spork, true, true, false},
        {"hanacryptobank", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"hanacryptobank", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use hanacryptobankd, or the -server option to hanacryptobank-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> hanacryptobank-cli " + methodname + " " + args + "\n";
}
