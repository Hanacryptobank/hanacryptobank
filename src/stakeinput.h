...
#ifndef HanaCryptoBank_STAKEINPUT_H
#define HanaCryptoBank_STAKEINPUT_H
...
public:
    ...
    bool IsZHCB() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, std::vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZHCB() override { return false; }
...
#endif //HanaCryptoBank_STAKEINPUT_H
