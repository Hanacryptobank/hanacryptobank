...
#ifndef HanaCryptoBank_ZHCBTRACKER_H
#define HanaCryptoBank_ZHCBTRACKER_H
...
public:
    CzHCBTracker(std::string strWalletFile);
    ~CzHCBTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzHCBWallet* zHCBWallet = NULL);
...
#endif //HanaCryptoBank_ZHCBTRACKER_H
