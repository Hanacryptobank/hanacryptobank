...
#ifndef HanaCryptoBank_ZHCBWALLET_H
#define HanaCryptoBank_ZHCBWALLET_H
...
public:
    CzHCBWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZHCB(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZHCB(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //HanaCryptoBank_ZHCBWALLET_H
