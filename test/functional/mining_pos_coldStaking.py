...
from test_framework.hanacryptobank_node import HanaCryptoBankTestNode
...
class HanaCryptoBank_ColdStakingTest(HanaCryptoBankTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(HanaCryptoBankTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 HCB from the pot)
...
if __name__ == '__main__':
    HanaCryptoBank_ColdStakingTest().main()
