...
class RawTransactionsTest(HanaCryptoBankTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid hanacryptobank address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid hanacryptobank address" in e.error['message'])
